...
yay -Syu --needed nekoray-bin libinput-gestures walker elephant elephant-calc elephant-clipboard elephant-desktopapplications elephant-files elephant-todo ttf-apple-emoji quickshell rose-pine-hyprcursor
